...
export const customTheme = {
  token: {
    colorPrimary: '#1677ff', // Основной цвет (можно изменить)
    colorBgContainer: '#f0f2f5', // Цвет фона контейнера (можно изменить)
    // ... другие переменные, которые вы хотите настроить
    fontFamily: 'Roboto, sans-serif', // Пример изменения шрифта
